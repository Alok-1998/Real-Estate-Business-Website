    ...
    <section class="home" id="home">
      <form action="">
        ...
        <div class="inputBox">
          ...
          <a href="search.jsp" class="btn">Search Property</a>
    </section>
    ...
    <section class="services" id="services">
      ...
      <div class="box-container">
        <div class="box">
          ...
          <a href="buyhome.jsp" class="btn">learn more</a>
        </div>
        ...
        <div class="box">
          ...
          <a href="renthome.jsp" class="btn">learn more</a>
        </div>
        ...
        <div class="box">
          ...
          <a href="sellhome.jsp" class="btn">learn more</a>
        </div>
        ...
        <div class="box">
          ...
          <a href="homeloan.jsp" class="btn">learn more</a>
        </div>
        ...
        <div class="box">
          ...
          <a href="propertymanagement.jsp" class="btn">learn more</a>
        </div>
        ...
        <div class="box">
          ...
          <a href="legalservices.jsp" class="btn">learn more</a>
        </div>
      </div>
    </section>
      ...
      <div class="box-container">
        <div class="box">
          ...
          <div class="content">
            ...
            <div class="buttons">
              <a href="request2.jsp" class="btn">request info</a>
              <a href="request2.jsp" class="btn">view details</a>
            </div>
          </div>
        </div>
        ...
        <div class="box">
          ...
          <div class="content">
            ...
            <div class="buttons">
              <a href="request6.jsp" class="btn">request info</a>
              <a href="request6.jsp" class="btn">view details</a>
            </div>
          </div>
        </div>
        ...
        <div class="box">
          ...
          <div class="content">
            ...
            <div class="buttons">
              <a href="request1.jsp" class="btn">request info</a>
              <a href="request1.jsp" class="btn">view details</a>
            </div>
          </div>
        </div>
        ...
        <div class="box">
          ...
          <div class="content">
            ...
            <div class="buttons">
              <a href="request9.jsp" class="btn">request info</a>
              <a href="request9.jsp" class="btn">view details</a>
            </div>
          </div>
        </div>
        ...
        <div class="box">
          ...
          <div class="content">
            ...
            <div class="buttons">
              <a href="request10.jsp" class="btn">request info</a>
              <a href="request10.jsp" class="btn">view details</a>
            </div>
          </div>
        </div>
        ...
        <div class="box">
          ...
          <div class="content">
            ...
            <div class="buttons">
              <a href="request3.jsp" class="btn">request info</a>
              <a href="request3.jsp" class="btn">view details</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="contact" id="contact">
      ...
      <div class="icons-container">
        ...
        <div class="icons">
          ...
          <p>Vasundhara Enclave, Delhi, India - 200301</p>
        </div>
      </div>

      <h1 class="heading"><span> Your</span> feedbacks</h1>
      <div class="row">
        <form action="">
          <div class="inputBox">
            <div class="fb">
            <input type="text" name="" placeholder="Name" id="test"  />
            <input type="text" name="" placeholder="Subject" id="test"  />
            </div>
            <div class="fb">
            <input type="text" name="" placeholder="Address" id="test"  />
            <input type="text" name="" placeholder="E-mail" id="test"  />
            </div>
            <textarea name="message" rows="10" cols="47" id="test" >
              Your message here...
              </textarea>
              <div>
              <a href="" class="btn" style="margin-left: 13rem;">Send</a>
              </div>
            </div>
          </form>
